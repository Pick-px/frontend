        ...
        <section>
          <h3 className='mb-3 flex items-center text-lg font-semibold text-yellow-300'>
            ...
            >
              <path
                fillRule='evenodd'
                d='M3 4a1 1 0 011-1h12a1 1 0 011 1v2a1 1 0 01-1 1H4a1 1 0 01-1-1V4zm0 4a1 1 0 011-1h12a1 1 0 011 1v6a1 1 0 01-1 1H4a1 1 0 01-1-1V8zm6 2a1 1 0 100-2 1 1 0 000 2z'
                clipRule='evenodd'
              />
            </svg>
            게임 규칙
          ...
          <ul className='space-y-2 text-gray-300'>
            ...
            <li className='flex items-start'>
              <span className='mt-1 mr-2 h-2 w-2 rounded-full bg-yellow-400'></span>
              <span>
                <strong>로그인 필수:</strong> 픽셀을 칠하려면 로그인이
                필요합니다
              </span>
            </li>
            <li className='flex items-start'>
        ...
        <section>
          ...
          <ul className='space-y-2 text-gray-300'>
            ...
            <li className='flex items-start'>
              <span className='mt-1 mr-2 h-2 w-2 rounded-full bg-purple-400'></span>
              <span>
                <strong>투명도 조절:</strong> 업로드한 이미지의 투명도를 조절할
                수 있습니다
              </span>
            </li>
            <li className='flex items-start'>
            ...
            <li className='flex items-start'>
              <span className='mt-1 mr-2 h-2 w-2 rounded-full bg-purple-400'></span>
              <span>
                <strong>그룹 기능:</strong> 그룹을 만들어 함께 작업할 수
                있습니다
              </span>
            </li>
          </ul>
